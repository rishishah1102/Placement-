...
public class PermutationOfString {
    ...
    public static void permutation(String str, String result) {
        // Here we will print the result when the string length will be 0 because there
        // will be nothing in str
        if (str.length() == 0) {
        ...
        for (int i = 0; i < str.length(); i++) {
            // Once selected one element we have to extract the remaining element so
            // extracted that element.
